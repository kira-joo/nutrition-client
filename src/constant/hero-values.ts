import { Award, Stethoscope, Users, type LucideIcon } from "lucide-react";

export interface HeroValueItem {
  key: "experience" | "clients" | "consultationYears";
  icon: LucideIcon;
}
 ...
 * one- or two-file change, not a component rewrite. `consultationYears`
 * is distinct from `experience`: the latter is general pharmacy/clinical
 * background, this one is specifically years spent giving nutrition
 * consultations.
 */
export const HERO_VALUE_ITEMS: HeroValueItem[] = [
  { key: "experience", icon: Award },
  { key: "clients", icon: Users },
  { key: "consultationYears", icon: Stethoscope },
];
